    ...
    <body>
        <div class="container">
            <div class="row">
                ...
                //$sql = "UPDATE 'vendedores' SET 'nome' = '$nome', 'endereco' = '$endereco', 'telefone' = '$telefone', 'email' = '$email', 'data_nascimento' = '$data_nascimento' WHERE id_vendedor = $id ";
                //$sql = "UPDATE 'vendedores' SET nome = '$nome', endereco = '$endereco', telefone = '$telefone', email = '$email', data_nascimento = '$data_nascimento' WHERE id_vendedor = $id ";
                //$sql = "UPDATE vendedores set nome = '$nome', endereco = '$endereco', telefone = '$telefone', email= '$email', data_nascimento = '$data_nascimento' where id_vendedor ='$id' ";
                //$sql = "UPDATE vendedores SET nome = '$nome', endereco = '$endereco', telefone = '$telefone', email = '$email', data_nascimento = '$data_nascimento' WHERE id_vendedor = $id ";
                //$sql = "UPDATE  `vendedores`  set `nome` = '$nome', `endereco` = '$endereco', `telefone` = '$telefone', `email` = '$email', `data_nascimento` = '$data_nascimento' WHERE id_vendedor = $id ";    
                ...
                ?>
                <hr>
                <a href="pesquisa_vendedores.php" class="btn btn-primary">Voltar</a>
            </div>
        </div>
